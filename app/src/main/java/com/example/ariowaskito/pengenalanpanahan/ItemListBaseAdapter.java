...
public class ItemListBaseAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.txt_itemAlamat= (TextView) convertView.findViewById(R.id.tittle);
		...
		holder.txt_itemAlamat.setText(itemDetailsrrayList.get(position).getalamat());
